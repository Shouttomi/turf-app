...
export function seedBookings() {
  return [
    { id: '#1042', customer: 'Arjun Mehta', phone: '+91 98765 43210', turf: 'Greenfield Arena', sport: 'Football', when: 'Today, 14 Jun', time: '8:00 – 9:00 PM', amount: 1200, pay: 'Pay at turf', status: 'pending', av: 0 },
    { id: '#1041', customer: 'Priya Nair', phone: '+91 90123 45678', turf: 'Smash Court Club', sport: 'Pickleball', when: 'Tomorrow, 15 Jun', time: '6:00 – 7:00 AM', amount: 600, pay: 'Advance ₹200', status: 'pending', av: 1 },
    { id: '#1040', customer: 'Karthik Rao', phone: '+91 99887 76655', turf: 'Boundary Line Box', sport: 'Cricket', when: 'Today, 14 Jun', time: '5:00 – 7:00 PM', amount: 3000, pay: 'Full prepay', status: 'pending', av: 2 },
    { id: '#1039', customer: 'Rohan Das', phone: '+91 90909 80808', turf: 'Skyline Hoops', sport: 'Basketball', when: 'Today, 14 Jun', time: '7:00 – 8:00 PM', amount: 900, pay: 'Full prepay', status: 'approved', av: 3 },
    { id: '#1038', customer: 'Meera Iyer', phone: '+91 98111 22333', turf: 'Shuttle Smash Hall', sport: 'Badminton', when: 'Mon, 15 Jun', time: '9:00 – 10:00 AM', amount: 450, pay: 'Pay at turf', status: 'approved', av: 4 },
    { id: '#1037', customer: 'Sahil Kapoor', phone: '+91 97000 11122', turf: 'Greenfield Arena', sport: 'Football', when: 'Sun, 14 Jun', time: '6:00 – 7:00 AM', amount: 1200, pay: 'Advance ₹400', status: 'approved', av: 5 },
    { id: '#1036', customer: 'Neha Gupta', phone: '+91 96655 44332', turf: 'Spike Sands Beach', sport: 'Volleyball', when: 'Sat, 13 Jun', time: '4:00 – 5:00 PM', amount: 700, pay: 'Full prepay', status: 'rejected', av: 6 },
    { id: '#1035', customer: 'Vikram Shetty', phone: '+91 95544 33221', turf: 'Boundary Line Box', sport: 'Cricket', when: 'Fri, 12 Jun', time: '8:00 – 10:00 PM', amount: 3000, pay: 'Full prepay', status: 'rejected', av: 7 },
  ];
}

export function seedNotifs() {
  return [
    { id: 'n1', type: 'request', text: 'New booking request — Arjun Mehta · Greenfield Arena', time: '2 min ago', unread: true },
    { id: 'n2', type: 'request', text: 'New booking request — Priya Nair · Smash Court Club', time: '18 min ago', unread: true },
